 ...
 * @subpackage Wp_favourite_button/admin
 */
 ...
 */
class Wp_favourite_button_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wp_favourite_button-admin.css', array(), $this->version, 'all' );
